...
class EmailService:
    """Email service - uses SendGrid when configured, falls back to logging"""
    ...
    async def send_email(
        ...
        try:
            ...
            if not settings.SENDGRID_API_KEY:
                ...
                logger.info(f"📧 Password in email: {html_content[:500]}...")
                return True
    ...
    <div class="content">
        ...
        <div class="credentials">
            ...
            <div class="credential-row">
                ...
                <span class="value" style="font-weight: bold; background: #fef3c7; padding: 2px 10px; border-radius: 4px;">{password}</span>
            </div>
        </div>
